        ...
        <>
            <div className="z-0 bg-[url('/images/bg-pricing.jpg')] bg-no-repeat bg-cover h-[400px] pt-8 relative flex flex-col items-center">
                ...
                <h1 className="relative text-center text-3xl leading-10 font-bold text-white z-10">
                    Increase your sales, buy cheap on Merkandi
                </h1>
                ...
                <div className='max-w-4xl m-auto'>
                    ...
                    <Questions
                        items={
                            [
                                {
                                title: 'Can I register on Merkandi without a company?',
                                content: 'Yes, private individuals can also create an account on Merkandi. However, please note that a small part of our wholesalers sell goods only to companies. Moreover, in order to sell on Merkandi you must have an active business.',
                                },
                                {
                                title: 'How can I make a purchase on Merkandi?',
                                content: 'To buy on Merkandi, you need to create an account and pay a registration fee. After payment, your account will be activated and you will get access to the contact details of the sellers.',
                                },
                                {
